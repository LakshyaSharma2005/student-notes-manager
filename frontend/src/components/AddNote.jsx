  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://notes-backend-f2oj.onrender.com/api/notes",
        data,
        {
      ...
      <div className="w-full max-w-lg bg-white p-8 rounded-3xl shadow-2xl border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            ...
            className={`w-full text-white font-bold py-4 rounded-2xl transition duration-300 shadow-lg shadow-blue-500/30 ${
